...
def main():
    ...
    while running:
        ...
        if player1_lost or player2_lost:
            ball.set_motion(
                to_rect_relitive_points(screen_rect, BallConstants.START_LOCATION, reverse_x=player1_lost),
                BallConstants.START_SLOPE, BallConstants.START_VELOCITY * (-1 if player1_lost else 1)
            )
